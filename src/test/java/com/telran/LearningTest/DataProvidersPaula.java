...
public class DataProvidersPaula {
    //Takes data from file
    @DataProvider
    public static Iterator<Object[]> pozitiveAdmin() throws IOException {
        BufferedReader in = new BufferedReader(new InputStreamReader(
                DataProvidersPaula.class.getResourceAsStream("/validLogin.data")));
    ...
    public static Iterator<Object[]> negativeAdmin() throws IOException {
        BufferedReader in = new BufferedReader(new InputStreamReader(
                DataProvidersPaula.class.getResourceAsStream("/invalidLogin.data")));
