...
public class LoginStasTest extends TestNgTestBase {
    ...
    public com.telran.pages.Learning.LoginStasPage LoginStasPage;
    public com.telran.pages.Learning.CompaniesStasPage CompaniesStasPage;


    @BeforeMethod
    public void initPageObjects() {
        LoginStasPage = PageFactory.initElements(driver, com.telran.pages.Learning.LoginStasPage.class);
        CompaniesStasPage = PageFactory.initElements(driver, com.telran.pages.Learning.CompaniesStasPage.class);
    }
