 ...
 * Sample page
 */
public class LoginPaulaPage extends Page {
  ...
  public LoginPaulaPage(WebDriver driver) {
  ...
  public void PaulaExpandManagementList() {
    clickElement(managementList);
  }

  public void PaulaTurnManagementList() {
    clickElement(managementList);
  }
