 ...
 */
public class TadiranProjectJulijaPage extends Page {
    ...
    public TadiranProjectJulijaPage(WebDriver driver) {
        super(driver);
    ...
    //methods
    public TadiranProjectJulijaPage waitForProjectPageIsLoaded() {
    ...
    public TadiranProjectJulijaPage clickHomeButton() {
