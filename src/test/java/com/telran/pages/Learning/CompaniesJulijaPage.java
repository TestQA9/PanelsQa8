 ...
 */
public class CompaniesJulijaPage extends Page {
    ...
    public CompaniesJulijaPage(WebDriver driver) {
        super(driver);
    ...
    public CompaniesJulijaPage waitForCompanyLabelHebrew() {
        Log.info("Waiting for companies page ");
    ...
    public CompaniesJulijaPage selectEnglishLanguage() {
        Log.info("Selecting for english language");
        selectValueInDropdown(selectLanguage, "en");
        return this;
    }

    public CompaniesJulijaPage selecthebrewLanguage() {
