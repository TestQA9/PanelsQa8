 ...
 */
public class LeftMenuJulijaPage extends Page {
    ...
    public LeftMenuJulijaPage(WebDriver driver) {
        super(driver);
        PageFactory.initElements(driver, this);
    }

    //methods
    public LeftMenuJulijaPage clickOnTopMenuButton() {
    ...
    public LeftMenuJulijaPage waitForleftMenuInLoaded() {
        Log.info("Waiting for left menu load");
        waitUntilIsLoaded(adminMenuBlock);
        return this;
    }

    public LeftMenuJulijaPage clickManagementButton() {
        Log.info("Clicking to management button");
        clickElement(managementButton);
        return this;
    }

    public LeftMenuJulijaPage clickCreateCompanyItemInDropdownManagement() {
        Log.info("Clicking to create company item");
        clickElement(createCompanyItem);
        return this;
    }

    public LeftMenuJulijaPage waitForCreateCompanyPageIsDisplayed() {
    ...
    public LeftMenuJulijaPage clickLogoutButton() {
    ...
    public LeftMenuJulijaPage clickReportsButton() {
